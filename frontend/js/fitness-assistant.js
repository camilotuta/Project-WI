  ...
  return React.createElement('div', null, [
    ...
    isOpen && React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', { key: 'title', className: 'flex-1' }, [
          React.createElement('h3', { key: 'h3', className: 'font-bold text-lg' }, 'Asistente Fitness'),
          React.createElement('p', { key: 'p', className: 'text-xs opacity-90' }, 'Siempre disponible para ayudarte')
        ]),
        React.createElement('button', {
          key: 'close',
      ...
      React.createElement('div', {
        ...
        ...messages.map((message, index) =>
          React.createElement('div', {
            ...
            style: message.type === 'user' ? { backgroundColor: '#059669' } : {}
          }, [
            React.createElement('p', { key: 'text', className: 'text-sm whitespace-pre-line' }, message.text),
            React.createElement('span', {
              key: 'time',
              className: `text-xs mt-1 block ${message.type === 'user' ? 'text-white/70' : 'text-gray-400'}`
        ...
        isTyping && React.createElement('div', {
          ...
          className: 'bg-white text-gray-800 rounded-2xl rounded-tl-none px-4 py-3 shadow-sm'
        }, React.createElement('div', { className: 'flex gap-1' }, [
          React.createElement('span', { key: '1', className: 'w-2 h-2 bg-gray-400 rounded-full animate-bounce', style: { animationDelay: '0ms' } }),
          React.createElement('span', { key: '2', className: 'w-2 h-2 bg-gray-400 rounded-full animate-bounce', style: { animationDelay: '150ms' } }),
          React.createElement('span', { key: '3', className: 'w-2 h-2 bg-gray-400 rounded-full animate-bounce', style: { animationDelay: '300ms' } })
        ]))),
      ...
      React.createElement('div', {
        ...
        React.createElement('button', {
          ...
          className: 'text-white rounded-full p-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors',
          style: { 
            width: '40px', 
            height: '40px',
          ...
          onMouseEnter: (e) => {
            if (inputValue.trim()) e.currentTarget.style.backgroundColor = '#047857';
          },
          onMouseLeave: (e) => {
            if (inputValue.trim()) e.currentTarget.style.backgroundColor = '#059669';
          }
        }, React.createElement('svg', { className: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
